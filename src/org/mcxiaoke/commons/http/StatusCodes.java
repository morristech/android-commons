...
/**
 * Constants enumerating the HTTP status codes. Includes status codes specified
 * in <a href="http://tools.ietf.org/html/rfc2616#section-10.3">RFC2616</a>
 * (HTTP/1.1).
 * 
 * @since 1.6
 * @author Ravi Mistry
...
public class StatusCodes {
	...
	public static final int STATUS_CODE_IO_ERROR = -1;
	...
	public static boolean isRedirect(int statusCode) {
		switch (statusCode) {
		case StatusCodes.STATUS_CODE_MOVED_PERMANENTLY: // 301
		case StatusCodes.STATUS_CODE_FOUND: // 302
		case StatusCodes.STATUS_CODE_SEE_OTHER: // 303
		case StatusCodes.STATUS_CODE_TEMPORARY_REDIRECT: // 307
			return true;
		default:
			return false;
		}
