...
public final class SslUtils {
	...
	public static TrustManagerFactory getDefaultTrustManagerFactory()
		...
		return TrustManagerFactory.getInstance(TrustManagerFactory
				.getDefaultAlgorithm());
	}
	...
	public static KeyManagerFactory getDefaultKeyManagerFactory()
			throws NoSuchAlgorithmException {
		return KeyManagerFactory.getInstance(KeyManagerFactory
				.getDefaultAlgorithm());
	}
	...
	/**
	 * Initializes the SSL context to the trust managers supplied by the trust
	 * manager factory for the given trust store.
	 * 
	 * @param sslContext
	 *            SSL context (for example {@link SSLContext#getInstance})
	 * @param trustStore
	 ...
	 * @since 1.14
	 */
	public static SSLContext initSslContext(SSLContext sslContext,
			KeyStore trustStore, TrustManagerFactory trustManagerFactory)
	 ...
	 * 
	 * <p>
	 * Be careful! Disabling SSL certificate validation is dangerous and should
	 ...
	 * 
	 * <p>
	 * Be careful! Disabling host name verification is dangerous and should only
	 * be done in testing environments.
	 * </p>
	 */
