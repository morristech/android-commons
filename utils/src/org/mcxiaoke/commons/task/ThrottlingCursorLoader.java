...
import org.mcxiaoke.commons.util.Throttle;
...
public class ThrottlingCursorLoader extends CursorLoader {
	private static final String LOG_TAG = "ThrottlingCursorLoader";
	private final Throttle mThrottle;

	/** Constructor with default timeout */
	public ThrottlingCursorLoader(Context context, Uri uri,
	...
	public ThrottlingCursorLoader(Context context, Uri uri,
			String[] projection, String selection, String[] selectionArgs,
			String sortOrder, int minTimeout, int maxTimeout) {
		...
		mThrottle = new Throttle(uri.toString(), forceLoadRunnable,
				new Handler(), minTimeout, maxTimeout);
	}

	private void debugLog(String message) {
		Log.d(LOG_TAG, "ThrottlingCursorLoader: [" + getUri() + "] " + message);
	}
